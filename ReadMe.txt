...
The code is easy to follow and well documented. And on top of that the class is very easy to use. Check it out, download is only 6.7 kB.

Two new options have been added - display tooltip always or only if parent form is active.
Quirk with no ToolTipText property has been fixed